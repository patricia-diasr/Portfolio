...
const videos = [
    ...
    }, 
    {
        ...
        description: 'Login do tutor no aplicativo, visualização de pagamentos e postagens de seus pets'
    }, 
    {
        name: 'login-tutor.mp4',
        title: 'Aplicativo (Tutor)',
        description: 'Login do administrador, visualização dos agendamentos do dia atual, e criação de postagens para pets hospedados'
    }
];
